...
//table
$query="select * from content where authorid='$id'";
...
$profile3=mysqli_fetch_object($profile1);
...
<div class="row">
  <div class="col-md-8">
    <div class="card">
          ...
          <div class="row">
            ...
            <div class="col-md-12 px-md-1">
              <div class="form-group">
                ...
                <input type="text" class="form-control"  value="<?php echo $profile2['name'] ?>">
              </div>
            </div>
            <div class="col-md-12 pl-md-1">
              <div class="form-group">
                <label for="exampleInputEmail1">Email address</label>
                <input type="email" class="form-control" value="<?php echo $profile2['email'] ?>">
              </div>
            </div>
            <div class="col-md-12 pr-md-1">
            <div class="form-group">
                <label>phone</label>
                <input type="text" class="form-control"   value="<?php echo $profile2['phont'] ?>">
              </div>
            </div>
          </div>
                  ...
                  <table class="table" id="myexamples">
                    ...
                    <?php
                      ...
                      <tr>
                          ...
                          <td>
                          <a href="./user.php?userid=<?php echo base64_encode($row['id']);  ?>" class="btn btn-primary">Read</a> <a href="./updateblog.php?userid=<?php echo base64_encode($row['id']);  ?>" class="btn btn-success">UPDATE</a>  <a href="./deletepost.php?userid=<?php echo base64_encode($row['id']); ?>" class="btn btn-danger">DELETE</a>
                        </td>
                      </tr>
                      <?php
                      $n=$n+1;
      ...
      <?php
      if ($profile2['premium']!=3)
    {
      $created=$profile2['postcreated'];
      $allowed= $profile2['postallowed'];
      $left=$profile2['postleft'];
      $now = time(); // or your date as well
      $your_date = strtotime($profile2['expirydate']);
      ...
      $created=$irw[0];
      $allowed='infinite';
      $left='You are a platinum user';

      $x='Life time';
    }
if($profile2['premium']==1||$profile2['premium']==2)
{
    if($x>0)
    {
      ?>

                  <h5 class="display-4 fst-italic">Post Created:<?php echo $created?></h5>
                  <h5 class="display-4 fst-italic">Post Allowed:<?php echo $allowed?></h5>
                  <h5 class="display-4 fst-italic">Post Left:<?php echo $left?></h5>
                  <br>
                  <h5 class="display-4 fst-italic"><?php echo $x?> days left on your premium</h5>
                  <br>
        <?php
}else
{
  ?>
                 <h5 class="display-4 fst-italic">Post Created:<?php echo $created?></h5>
                  <h5 class="display-4 fst-italic">Post Allowed:0</h5>
                  <h5 class="display-4 fst-italic">Post Left:0</h5>
                  <br>
                  <h5 class="display-4 fst-italic">Your Premium has expired please Recharge</h5>
                  <br>
  <?php
}
...
} else
{
  ...
  <h5 class="display-4 fst-italic">Post Left:<?php echo $left?></h5>
  <br>
  <h5 class="display-4 fst-italic"><?php echo $x?> Left on your premium</h5>
  <br> 
  <?php
}    
       ?>        
