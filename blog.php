...
<body>
  ...
  <header id="header" class="fixed-top header-inner-pages">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo mr-auto"><a href="#">BLOG</a></h1>
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li class="drop-down"><a href="">Category</a>
            <ul>
              <li class="drop-down"><a href="#">Web Tutorials</a>
               <ul>
                  <li><a href="#">Php Tutorial</a></li>
                  <li><a href="#">MySql Tutorial</a></li>
                  <li><a href="#">DB Tutorials</a></li>
                  <li><a href="#">NoSql Tutorials</a></li>
                  <li><a href="#">Cake Php TUtorials</a></li>
                </ul>
              </li>
              <li class="drop-down"><a href="#">Programming Languages</a>
                <ul>
                  <li><a href="#">Basic Programming</a></li>
